describe("Check that the size of fonts are correct", () => {
  ...
  it("Check that the font-family is correct and paragraphs size are correct", () => {
    cy.visit(baseUrl);
    cy.get("body")
      .should("have.css", "font-family", "Raleway");
    cy.get("p")
  ...
  it("Check that the color in primary buttons is correct", () => {
    ...
    cy.get(".button.button--primary")
      .should("have.css", "background", "rgb(95, 174, 228) none repeat scroll 0% 0% / auto padding-box border-box");
  });
  ...
  it("Check that the color in secondary buttons is correct", () => {
    ...
    cy.get(".button.button--secondary")
      .should("have.css", "background", "rgb(0, 43, 93) none repeat scroll 0% 0% / auto padding-box border-box");
  });
